...
> **勘误（2026-08-29 学员更正）**：Ingoo 在职时间为 **2026.03.22 - 2026.08（5 个月）**，非此前推定的 2025.11 起；2025.11-2026.03 为学员主动休整期（gap 话术见 reference/0002）。另：嘉立创项目经历系 big-market 包装（本地 /Users/1ea/IdeaProjects/big-market；DDD 七域 / db-router 分库分表 / Redisson / xxl-job / 规则树，主链路无 MQ，走 task 任务表 + 定时补偿）；该阶段学员为中级开发，简历角色定"核心开发"。power-bank 实勘结论不受影响。
