...
- 已交付：0002 MySQL 追问链（8/27-8/28 主线，自评 1 → 目标 4，过关后回 0001 自评表改分）；含"链 1 地基"扩展节（对照《MySQL 实战 45 讲》第 1/2/4 讲——用户指定深挖参考，已入 RESOURCES.md）；8/28 链 1 补全：非自增主键三步灾难（页分裂/碎片/随机IO）+ 索引类型三维度全景独立块 + 扇出定义入地基节
